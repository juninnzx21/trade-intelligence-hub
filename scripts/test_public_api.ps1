...
Write-Host "GET $BaseUrl/api/v1/market/latest?asset=EUR/USD&timeframe=M1"
Invoke-RestMethod -Uri "$BaseUrl/api/v1/market/latest?asset=EUR/USD&timeframe=M1" -Headers $headers -Method Get | ConvertTo-Json -Depth 6
